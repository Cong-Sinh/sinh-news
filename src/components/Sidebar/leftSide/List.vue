<template>
    <router-link to="/" class="text-grey8 font-normal mb-[15rem]   ">
        <div v-for="(item, index) in items" :key="index" class="flex items-center font-semibold  w-[220px]  h-10">
            <NameAndColor :name="item.name" class="hover:bg-gray-300 py-3 font-normal w-full pl-1"
